...
- **githubRepo** — your username and repository name, exactly as they appear in the address bar. This makes every "Flag this" button work.
...
You can now add timeline entries, synagogues, people, articles, figures, statements, sources and corrections through forms. Every save publishes a new version of the site within a minute or two.
