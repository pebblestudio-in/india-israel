...
|---|---|
| Timeline | 39 dated entries, from community tradition to January 2026 |
| Map | Real coastlines from Natural Earth, community centres, migration routes |
| Synagogue Directory | 13 Jewish sites in India, with dates, condition and sources |
...
| Hebrew and Hindi | Both alphabets in full, compared, with learning resources |
| Statements Wall | Every logged government interaction, from primary sources |
| Library | 22 pieces, about 10,700 words |
| Open Dataset | Everything, as CSV and JSON, free to reuse |

About 19,000 words of sourced content across the content files.
...
| `scripts/make-geo.mjs` | Rebuilds map geometry from Natural Earth. |
